...
def get_all_article_ids(
    ...
    all_ids = []
    retrieved_cache = []  # TODO: load names of files with IDs to skip extraction of IDs for the same set of search params
    retrieved_counts = {}
    n_retrievals = 0
    ...
    while len(stack) > 0:
        ...
        if n_results is not None or pars_as_key in retrieved_cache:
