...
#     for _file in files:
#         print(_file)
# with open('cache/get_content_id/a1/w5.json', 'r') as f:
#     file = json.load(f)
# listing_details = file['props']['pageProps']['listingDetails']
# print(file)
...
bucket_name = 'scrapautoscout-bucket'
folder_name = '08tDJafk5GYOiiKCydaNVA/'
file = f'{folder_name}12b2def9-dd6f-4790-abbf-d4c433086aa5.json'
